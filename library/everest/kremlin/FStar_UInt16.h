...
#ifndef __FStar_UInt16_H
#define __FStar_UInt16_H
...
extern uint16_t FStar_UInt16_eq_mask(uint16_t x0, uint16_t x1);

extern uint16_t FStar_UInt16_gte_mask(uint16_t x0, uint16_t x1);

extern Prims_string FStar_UInt16_to_string(uint16_t x0);

extern uint16_t FStar_UInt16_of_string(Prims_string x0);

#define __FStar_UInt16_H_DEFINED
#endif
