...
Prims_int FStar_Math_Lib_log_2(Prims_pos x);

Prims_int FStar_Math_Lib_powx(Prims_int x, Prims_int n);

Prims_int FStar_Math_Lib_abs(Prims_int x);

Prims_int FStar_Math_Lib_max(Prims_int x, Prims_int y);

Prims_int FStar_Math_Lib_min(Prims_int x, Prims_int y);

Prims_int FStar_Math_Lib_div_non_eucl(Prims_int a, Prims_pos b);

Prims_int FStar_Math_Lib_shift_left(Prims_int v, Prims_int i);

Prims_int FStar_Math_Lib_arithmetic_shift_right(Prims_int v, Prims_int i);

Prims_int FStar_Math_Lib_signed_modulo(Prims_int v, Prims_pos p);

Prims_int FStar_Math_Lib_op_Plus_Percent(Prims_int a, Prims_pos p);
