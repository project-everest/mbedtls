 ...
 * KreMLin invocation: /mnt/f/dev/sec/everest/verify-no-uint128/kremlin/krml -minimal -fnouint128 /mnt/f/dev/sec/everest/verify-no-uint128/FStar/ulib/FStar.UInt128.fst -tmpdir ../secure_api/out/runtime_switch/uint128 -skip-compilation -add-include "kremlib0.h" -drop FStar.Int.Cast.Full -fc89-scope -fc89 -falloca -ftail-calls -bundle FStar.UInt128=FStar.*,Prims
 * F* version: 303a537f
 * KreMLin version: d3643277
 */

#include "mbedtls/FStar_UInt128.h"
#include "mbedtls/kremlib.h"

extern krml_checked_int_t Prims_op_Multiply(krml_checked_int_t x0, krml_checked_int_t x1);

extern krml_checked_int_t Prims_op_Division(krml_checked_int_t x0, krml_checked_int_t x1);

extern krml_checked_int_t Prims_op_Addition(krml_checked_int_t x0, krml_checked_int_t x1);

extern krml_checked_int_t Prims_op_Modulus(krml_checked_int_t x0, krml_checked_int_t x1);

extern krml_checked_int_t Prims_pow2(krml_checked_int_t x0);

Prims_int FStar_UInt128_n = (krml_checked_int_t)128;
...
Prims_int FStar_UInt128_v(FStar_UInt128_uint128 x)
{
  return
    Prims_op_Addition(FStar_UInt64_v(x.low),
      Prims_op_Multiply(FStar_UInt64_v(x.high), Prims_pow2((krml_checked_int_t)64)));
}

FStar_UInt128_uint128 FStar_UInt128_uint_to_t(Prims_int x)
{
  FStar_UInt128_uint128
  flat =
    {
      FStar_UInt64_uint_to_t(Prims_op_Modulus(x, Prims_pow2((krml_checked_int_t)64))),
      FStar_UInt64_uint_to_t(Prims_op_Division(x, Prims_pow2((krml_checked_int_t)64)))
    };
  return flat;
}
...
FStar_UInt128_add_underspec(FStar_UInt128_uint128 a, FStar_UInt128_uint128 b)
{
  ...
  flat =
    {
      a.low + b.low,
      FStar_UInt64_add_underspec(FStar_UInt64_add_underspec(a.high, b.high),
...
FStar_UInt128_sub_underspec(FStar_UInt128_uint128 a, FStar_UInt128_uint128 b)
{
  ...
  flat =
    {
      a.low - b.low,
      FStar_UInt64_sub_underspec(FStar_UInt64_sub_underspec(a.high, b.high),
...
{
  FStar_UInt128_uint128
  flat = { (uint64_t)0U, a.low << (s - FStar_UInt128_u32_64) };
  return flat;
}
...
{
  FStar_UInt128_uint128
  flat = { a.high >> (s - FStar_UInt128_u32_64), (uint64_t)0U };
  return flat;
}
