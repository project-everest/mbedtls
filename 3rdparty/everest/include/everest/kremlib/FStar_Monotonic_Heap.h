...
FStar_Pervasives_Native_option__FStar_Pervasives_dtuple4_____FStar_Pervasives_Native_option_____bool_any
(*FStar_FunctionalExtensionality_on_dom__Prims_pos_FStar_Pervasives_Native_option_FStar_Pervasives_dtuple4____FStar_Pervasives_Native_option____bool_any(
  FStar_Pervasives_Native_option__FStar_Pervasives_dtuple4_____FStar_Pervasives_Native_option_____bool_any
  (*f)(Prims_pos x0)
))(Prims_pos x0);
