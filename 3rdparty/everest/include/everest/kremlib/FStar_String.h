...
extern Prims_list__FStar_Char_char *FStar_String_list_of_string(Prims_string x0);

extern Prims_string FStar_String_string_of_list(Prims_list__FStar_Char_char *x0);

extern Prims_int FStar_String_strlen(Prims_string x0);

extern Prims_int FStar_String_length(Prims_string x0);

extern Prims_string FStar_String_make(Prims_int x0, FStar_Char_char x1);

extern Prims_list__Prims_string
*FStar_String_split(Prims_list__FStar_Char_char *x0, Prims_string x1);

extern Prims_string FStar_String_strcat(Prims_string x0, Prims_string x1);

extern Prims_string FStar_String_op_Hat(Prims_string x0, Prims_string x1);

extern Prims_string FStar_String_concat(Prims_string x0, Prims_list__Prims_string *x1);

extern Prims_int FStar_String_compare(Prims_string x0, Prims_string x1);

extern Prims_string FStar_String_lowercase(Prims_string x0);

extern Prims_string FStar_String_uppercase(Prims_string x0);

extern FStar_Char_char FStar_String_index(Prims_string x0, Prims_int x1);

extern Prims_int FStar_String_index_of(Prims_string x0, FStar_Char_char x1);

extern FStar_Char_char FStar_String_sub(Prims_string x0, Prims_int x1, Prims_int x2);

extern Prims_string FStar_String_substring(Prims_string x0, Prims_int x1, Prims_int x2);

extern FStar_Char_char FStar_String_get(Prims_string x0, Prims_int x1);

extern Prims_string
FStar_String_collect(Prims_string (*x0)(FStar_Char_char x0), Prims_string x1);
