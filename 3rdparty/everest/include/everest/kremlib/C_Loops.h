...
void C_Loops_for_(uint32_t start, uint32_t finish, void (*f)(uint32_t x0));

void C_Loops_for64(uint64_t start, uint64_t finish, void (*f)(uint64_t x0));

void C_Loops_reverse_for(uint32_t start, uint32_t finish, void (*f)(uint32_t x0));
