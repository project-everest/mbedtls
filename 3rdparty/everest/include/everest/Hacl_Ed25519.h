/*
  ...
  KreMLin invocation: /mnt/e/everest/verify/kremlin/krml -tmpdir ed25519-c89 -fc89 -verbose -verbose -I /mnt/e/everest/verify/hacl-star/code/old/lib/kremlin -I /mnt/e/everest/verify/kremlin/kremlib/compat -I /mnt/e/everest/verify/hacl-star/specs -I /mnt/e/everest/verify/hacl-star/specs/old -I . -fparentheses -fcurly-braces -fno-shadow -ccopt -march=native -verbose -ldopt -flto -I ../bignum -I ../curve25519 -I ../hash -header /mnt/e/everest/verify/kremlin/kremlib/copyright-header.txt -bundle Hacl.Ed25519=* -minimal -add-include "kremlib.h" -skip-compilation ed25519-c/out.krml -o ed25519-c89/Hacl_Ed25519.c
  F* version: 2e077f7c
