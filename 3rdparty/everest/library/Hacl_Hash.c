...
void Hacl_Hash_Core_MD5_pad(uint64_t len, uint8_t *dst)
{
  uint8_t *dst1 = dst;
  uint8_t *dst2;
  uint8_t *dst3;
...
void Hacl_Hash_Core_SHA1_pad(uint64_t len, uint8_t *dst)
{
  uint8_t *dst1 = dst;
  uint8_t *dst2;
  uint8_t *dst3;
    ...
    +
      ...
      +
        ...
        -
          ...
          + (uint32_t)(FStar_UInt128_uint128_to_uint64(len) % (uint64_t)(uint32_t)128U)))
        % (uint32_t)128U;
  store128_be(dst3, FStar_UInt128_shift_left(len, (uint32_t)3U));
}
